...
Clarinet.test({
  name: `${contractNames.clarityBitcoin} can parse and verify tx`,
  async fn(chain: Chain, accounts: Map<string, Account>) {
    const deployer = accounts.get('deployer')!;

    const transferrable_parsed = chain
      .callReadOnlyFn(
        contractNames.clarityBitcoin,
        'parse-wtx',
...
Clarinet.test({
  name: `${contractNames.oracle} can hash, validate and index`,
  async fn(chain: Chain, accounts: Map<string, Account>) {
    const deployer = accounts.get('deployer')!;
    ...
    const signaturePack = {
      signature:
        '0x7609781822d5a1e8ffc602c10d58340430ed0d342f3efb606bc3f69127c4535f7ebfb57e5313985f65fbd385e2814b0fa03407b4c4b1cc1da237a6f7bc4c2fb500',
